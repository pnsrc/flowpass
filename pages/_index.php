      ...
      <div class="main__container container">
        <div class="main__row">
          ...
          <div class="main__form col-md-10 col-lg-5">
            <form id="form" method="POST" action="#" class="main__form-login form p-4 p-md-5 border rounded-3 bg-light">
              <div class="form-floating form-label">
                <input type="text" name="email" class="form-control form-input _required" id="floatingInput" placeholder="name@example.com">
